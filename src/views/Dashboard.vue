            ...
            <div class="container relative mx-auto">
                <div class="items-center flex flex-wrap">
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            <h1 class="text-white font-semibold text-5xl">The Cookbook vs the Guide</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                            ...
                            >
                                ...
                                <blockquote class="relative p-8 mb-4">
                                    ...
                                    <h4 class="text-xl font-bold text-white">{{ blog.title }}</h4>
                                    <p class="text-md font-light mt-2 text-white">{{ blog.body }}</p>
                                </blockquote>
                            </div>
                        </div>
                    </router-link>
...
export default {
    ...
    methods: {
        async getBlogs() {
            let snapshot = await db.collection('blog').get()
            let blogs = []
